...
export default function CreateOfferScreen() {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-[#0b1120] to-[#151b2c] text-white flex justify-center items-start sm:items-center p-4">
      <div className="w-full max-w-md sm:max-w-sm mt-6 sm:mt-0">
        ...
        <form
          ...
          className="bg-[#1a2338] p-5 rounded-2xl shadow-md space-y-4 overflow-auto max-h-[calc(100vh-2rem)]"
        >
          {/* Sell / Currency */}
