...
export default function LoginScreen() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center bg-[#0b1120]">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-white">Вход</h1>

      <form onSubmit={handleSubmit(onSubmit)} className="w-full sm:max-w-sm space-y-4">
        <div>
